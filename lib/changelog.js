...
export const CHANGELOG = [
  {
    ...
    fecha: '2026-09-25',
    cambios: [
      'Productos y valores: arreglado el cálculo de "Pago único" (y el resto de "Precios y beneficios") en productos con cuotas escalonadas — el descuento se aplicaba sobre el Valor de lista en vez de sobre la suma real de las cuotas escalonadas, dando un precio mucho más bajo del que corresponde (ej: Coaching Ontológico Profesional mostraba $136.098 en vez de $564.400).'
    ]
  },
  {
    version: '10.15.0',
    fecha: '2026-09-25',
    cambios: [
      'Inscritos: si después se corrige el nombre o el curso en la ficha de un lead, la lista ahora se actualiza sola (antes se quedaba mostrando el nombre/curso viejo para siempre, aunque la ficha ya mostrara el dato corregido).',
      'Inscritos: el cartel de "acciones pendientes por realizar" ahora se puede cerrar con la cruz — vuelve a aparecer solo al otro día si sigue habiendo pendientes.',
      'Inscritos: "Reenviar alta" ahora avisa si algo salió mal en vez de dar el reenvío por hecho igual (antes, si fallaba, el estudiante se quedaba pegado en la alerta sin ningún aviso).',
      'Académico: la tabla ahora ordena bien de la edición más nueva a la más vieja (antes se desordenaba con fechas cargadas como texto en vez de con el selector de fecha).',
      'Académico: corregido que a veces el Formador elegido para una edición no quedaba guardado al recargar, por una comparación de textos demasiado estricta con la edición.',
      'Comunidades: ya muestra la lista de ventas de Comunidades (antes decía "Próximamente").',
      'Emails: la pantalla se agrandó (antes quedaba angosta).',
      'Menú: las secciones a las que probablemente no tenés acceso (por ejemplo al ver la app "como" otra persona) ahora se ven atenuadas, en vez de mostrarse igual que el resto.'
    ]
  },
  {
    version: '10.14.2',
    fecha: '2026-09-23',
    cambios: [
      'Modo oscuro: los desplegables nativos ahora si se ven con fondo oscuro y texto claro (se estilaron las opciones con los colores del tema).'
    ]
  },
  {
    version: '10.14.1',
    fecha: '2026-09-23',
    cambios: [
      'Modo oscuro: los desplegables nativos (meses, plataforma, etc.) ahora se ven oscuros y legibles en vez de blancos.'
    ]
  },
  {
    version: '10.14.0',
    fecha: '2026-09-23',
    cambios: [
      'Ver como: solo Diego puede previsualizar la app como otra persona, con un banner de modo vista.',
      'Nuevo boton "Necesito ayuda" con un recorrido guiado por las secciones principales.',
      'Dashboard mas ancho, para que la tabla de acciones pendientes no se corte a la derecha.',
      'Informes RRSS: al pasar el mouse por el grafico de evolucion se muestra el mes y el numero.',
      'Informes RRSS: el desplegable de meses lista todos los meses recientes (ya aparece agosto) y en modo oscuro ya no se ve en blanco.'
    ]
  },
  {
    version: '10.13.1',
    fecha: '2026-09-18',
    cambios: [
      'Reportes: los gráficos de "Evolución de ventas por día" y "Evolución de facturación e ingresos por día" ahora marcan con una línea naranja "Hoy" — solo cuando el mes elegido es el mes actual.'
    ]
  },
  {
    version: '10.13.0',
    fecha: '2026-09-18',
    cambios: [
      'Historial de bajas: ahora se puede editar el Curso y la Edición de cada fila con un clic, directo desde la tabla (con autocompletado de los cursos oficiales) — para corregir nombres mal cargados sin tener que ir a buscar la ficha del lead.'
    ]
  },
  {
    version: '10.12.3',
