...
export async function enviarMailBienvenidaEstudiante(destinatarioEmail, nombreEstudiante) {
  const transporter = getTransporter();
  const html = `
  <div style="font-family: -apple-system, Segoe UI, Arial, sans-serif; max-width: 560px; margin: 0 auto; background:#ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e5e7eb;">
    ...
    <div style="padding: 28px;">
      ...
      <p style="font-size: 14px; color:#374151; line-height:1.6; margin: 0 0 16px;">
        ...
        <a href="https://bio.link/tutorialesilce" style="color:#0369a1;">bio.link/tutorialesilce</a>
      </p>
      <p style="font-size: 14px; color:#374151; margin: 0 0 16px;">Cualquier duda o consulta estamos a disposición.</p>
      <p style="font-size: 14px; color:#374151; margin: 0 0 20px;">PD: podrás confirmarnos respuesta de este correo a <a href="mailto:estudiantes@institutoilce.com" style="color:#0369a1;">estudiantes@institutoilce.com</a></p>
...
export async function enviarMailAltaPlataforma(destinatarioEmail, nombreEstudiante, curso) {
  const transporter = getTransporter();
  const html = `
  <div style="font-family: -apple-system, Segoe UI, Arial, sans-serif; max-width: 560px; margin: 0 auto; background:#ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e5e7eb;">
    <div style="background: linear-gradient(135deg, #0f1f3d, #7c3aed); padding: 24px 28px;">
    ...
    <div style="padding: 28px;">
      ...
      <p style="font-size: 14px; color:#374151; line-height:1.6; margin: 0 0 16px;">
        ...
        ya puedas ir ingresando y viendo el contenido previo de la Formación ${curso || ''}!
      </p>
      <p style="font-size: 14px; color:#374151; line-height:1.6; margin: 0 0 16px;">
        Te compartimos los <a href="https://bio.link/tutorialesilce" style="color:#0369a1;">Tutoriales ILCE</a> para que puedan
      ...
      <p style="font-size: 14px; color:#374151; margin: 0 0 16px;">Cualquier duda o consulta estamos a disposición.</p>
      <p style="font-size: 14px; color:#374151; margin: 0;">PD: podrás confirmarnos respuesta de este correo a <a href="mailto:estudiantes@institutoilce.com" style="color:#0369a1;">estudiantes@institutoilce.com</a></p>
    </div>
    <div style="background:#f9fafb; padding: 14px 28px; text-align:center;">
      <p style="font-size: 11px; color:#9ca3af; margin:0;">Departamento de Estudiantes — Instituto ILCE</p>
    </div>
